  ...
  return (
    <div className={styles.dropdown}>
      ...
      {isModelOpened && (
        ...
        >
          <p className={styles.modalText}>Удалить задачу?</p>
          <button className={styles.btnDelete} onClick={handleDeletTask}>
            Удалить
          </button>
          <button className={styles.btnCancel} onClick={() => setIsModalOpened(false)}>
            Отмена
          </button>
        </ModalWindow>
      )}
